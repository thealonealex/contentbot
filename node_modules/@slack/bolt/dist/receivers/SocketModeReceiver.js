...
class SocketModeReceiver {
    ...
    constructor({ appToken, logger = undefined, logLevel = logger_1.LogLevel.INFO, clientPingTimeout = undefined, serverPingTimeout = undefined, pingPongLoggingEnabled = undefined, autoReconnectEnabled = undefined, clientId = undefined, clientSecret = undefined, stateSecret = undefined, redirectUri = undefined, installationStore = undefined, scopes = undefined, installerOptions = {}, customRoutes = [], customPropertiesExtractor = (_args) => ({}), processEventErrorHandler = SocketModeFunctions_1.defaultProcessEventErrorHandler, }) {
