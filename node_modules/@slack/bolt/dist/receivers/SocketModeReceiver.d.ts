...
export default class SocketModeReceiver implements Receiver {
    ...
    constructor({ appToken, logger, logLevel, clientPingTimeout, serverPingTimeout, pingPongLoggingEnabled, autoReconnectEnabled, clientId, clientSecret, stateSecret, redirectUri, installationStore, scopes, installerOptions, customRoutes, customPropertiesExtractor, processEventErrorHandler, }: SocketModeReceiverOptions);
    init(app: App): void;
